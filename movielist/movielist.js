(function(angular){
  'use strict';
  // 正在热映模块
  var app = angular.module('moviecat.movielist',['ngRoute','moviecat.jsonp']);
  // 路由配置
  ...
  app.controller('movielistController',[
    ...
    function($scope,$http,$routeParams,$route,MyService){
      ...
      // 请求数据
      // MyService.jsonp('http://api.douban.com/v2/movie/movielist'
    ...
    // $http.jsonp('http://api.douban.com/v2/movie/movielist?callback=JSON_CALLBACK')
    // .then(function(response){
    //   console.log(response);
    // });
